...
def innerL(i, obj):
    ...
    '''
    KTT条件：
           primal feasible：y_n(W_T*Z_n + b)>=1
           dual feasible:  alpha_n >= 0
           dual inner optimal: sum(alpha_n*y_n) = 0,sum(alpha_n*y_n*z_n)  
           primal-inner optimal alpha_n*(1-y_n*(W_T*)
    '''
    # 如果目前x不能满足KTT条件
